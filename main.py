...
if __name__ == '__main__':
    ...
    for epoch in range(epoch):
        ...
        if epoch % 100 == 0:
            ...
            test_auc, ap, top_k, f1_fixed, f1_optimal = test(user_emb,g,friend_list_index_test)
            ...
            if ap > best_ap:
                best_ap = ap
                print("beat_ap:", ap)
            if f1_fixed > best_f1_fixed_val:
                best_f1_fixed_val = f1_fixed
            if f1_optimal > best_f1_optimal_val:
                best_f1_optimal_val = f1_optimal
                
            need_write="epoch"+str(epoch)+" best_auc: "+str(best_auc)+" best_ap: "+str(best_ap)+" best_f1_fix: "+str(best_f1_fixed_val)+" best_f1_opt: "+str(best_f1_optimal_val)+" loss: "+str(loss.item())
